    ...
    <main className="pt-16">
      ...
      <section className="relative bg-brand-dark text-white py-28 md:py-36 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-white mb-8 italic font-light">"We Got You Fellow Graduate"</p>
      ...
      <section className="max-w-7xl mx-auto py-16 px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { icon: <Truck size={32} className="text-brand-gold"/>, title: "Fast Local Service", text: "Based in Thohoyandou with quick pickup options and delivery across Limpopo." },
